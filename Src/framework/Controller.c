...
volatile usercmdkey_t usercmdKeysModeA[] = { { slider_a, ub_sliderA }, { slider_b, ub_sliderB },
		{ slider_c, ub_sliderC }, { slider_d, ub_sliderD },
...
//
volatile usercmdkey_t usercmdKeysModeB[] = { { slider_a, ub_sliderA }, { slider_b, ub_sliderB },
		{ slider_c, ub_sliderC }, { slider_d, ub_sliderD },
